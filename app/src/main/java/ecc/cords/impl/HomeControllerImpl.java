...
public class HomeControllerImpl extends SimpleFormController implements HomeController  {
	...
	public ModelAndView showForm(HttpServletRequest req, HttpServletResponse res, BindException errors) {
		...
		if(req.getParameter("viewEmpBtn") != null) {
			return new ModelAndView("redirect:/employee/viewPage?empId=" + req.getParameter("viewEmpBtn"));
		}
