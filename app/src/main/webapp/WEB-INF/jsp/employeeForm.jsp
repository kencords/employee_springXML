  	...
  	<body>
  		...
  		<div style="border:1px solid black; width:500px; margin: 0 auto; text-align:center;">
  			...
  			<form method="POST">
  				...
  				<!--<input type="date" name="birthDate" value ="${param.birthDate}" placeholder="Birthdate (yyyy-mm-dd)*"><br> -->
	  			...
	  			<!--<input type="date" name="hireDate" value ="${param.hireDate}" placeholder="Hire Date (yyyy-mm-dd)"><br> -->
	  			<h3>ROLES</h3>
