...
INSERT INTO address(str_no, street, brgy, city, zipcode) VALUES(8,'RnR','Brgy 0Z', 'Z City','5500');

INSERT INTO employees(lastname, firstname, middlename, suffix, title, addr_id, birthdate, gwa, hiredate, currentlyhired)
	VALUES('Buu','Bibidi','Babidy','','M',4,'1990-12-01',1.75,'2005-02-08','f');

INSERT INTO contacts(emp_id,contact_type,contact_value) VALUES(4,'Email','buu@gmail.com');
INSERT INTO contacts(emp_id,contact_type,contact_value) VALUES(4,'Landline','666-6666');
INSERT INTO contacts(emp_id,contact_type,contact_value) VALUES(4,'Mobile','1111-111-1111');

INSERT INTO employee_role(emp_id, role_id) VALUES(4,2);